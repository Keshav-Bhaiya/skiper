      ...
      <div className="flex flex-col items-center px-4 sm:px-6 lg:px-8 xl:px-12 py-8 sm:py-12 md:py-16 lg:py-20 xl:py-24">
        ...
        <div className="mb-6 sm:mb-8 md:mb-10 lg:mb-12">
          <WrapButton
            ...
            className="px-5 sm:px-8 md:px-4 py-3 sm:py-4 md:py-4 text-sm sm:text-base md:text-lg font-medium transition-all duration-300 hover:scale-105 hover:shadow-xl active:scale-95"
          >
            <Globe className="animate-spin mr-2 w-4 h-4 sm:w-5 sm:h-5 md:w-6 md:h-6" />
            Get Started
          </WrapButton>
        </div>

        {/* Scroll Arrow SVG */}
        <div className="mb-6 sm:mb-8 md:mb-10 opacity-60 dark:opacity-70 hover:opacity-80 transition-opacity duration-300">
          <svg
            width="80"
            height="40"
            viewBox="0 0 100 50"
            ...
            className="fill-black dark:fill-white w-12 h-6 sm:w-16 sm:h-8 md:w-20 md:h-10 lg:w-24 lg:h-12 animate-bounce hover:animate-pulse transition-all duration-300"
          >
        ...
        {/* Description Text */}
        <div className="text-center max-w-xs sm:max-w-md md:max-w-lg lg:max-w-xl xl:max-w-2xl px-4">
          <p className="text-base sm:text-lg md:text-xl lg:text-2xl text-black/60 dark:text-white/60 leading-relaxed tracking-wide">
            To make your dream Website live by just{" "}
            <span className="font-bold text-black/80 dark:text-white/80 bg-gradient-to-r from-gray-900 to-gray-700 dark:from-white dark:to-gray-300 bg-clip-text ">
              Copy and paste
            </span>
          </p>
        </div>
